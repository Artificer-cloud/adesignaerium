...
export const projects: Project[] = [
  {
    ...
    longDescription: `Krossover Gifts is a Dubai-based B2B corporate gifting company serving 100+ clients across the UAE. I led the complete creative direction — from brand identity and packaging design to e-commerce UI/UX and digital campaigns.\n\nThe challenge was building a brand that felt premium and trustworthy while remaining approachable for bulk corporate orders. Every touchpoint — product photography, catalogue design, website UI, social content — was designed to work as a unified system.`,
    category:    ['UI/UX', 'Branding', 'E-Commerce'],
    color:       '#060d18',
    year:        '2023–Present',
    client:      'Krossover Gifts Trading LLC',
    role:        ['Creative Director', 'UI/UX Designer', 'Brand Designer'],
    tags:        ['Branding', 'E-Commerce', 'UI/UX', 'Packaging', 'Photography'],
  ...
  },
  {
    ...
    longDescription: `Shanghai Gifts is a sister brand under the same corporate umbrella as Krossover. I designed the complete e-commerce experience — product listings, category pages, checkout flow, and brand identity.\n\nThe brand needed to feel distinctly different from Krossover while sharing the same quality standard. I used a cooler, more minimal palette and editorial-style product photography to differentiate it in the market.`,
  ...
  },
  {
    ...
    longDescription: `Ecora is a sustainable corporate gifting brand I built from scratch. The brief was to create something that felt genuinely eco-conscious — not greenwashed — with a visual identity that matched the product values.\n\nI developed the full brand system: logo, color palette, typography, packaging design, and web presence. The website was built in Next.js with a focus on clean, fast performance.`,
    category:    ['Branding', 'UI/UX'],
    color:       '#040f07',
    year:        '2024',
    client:      'Ecora',
    role:        ['Brand Designer', 'Web Designer', 'Developer'],
    tags:        ['Branding', 'Sustainability', 'Web Design', 'Next.js'],
  ...
  },
  {
    ...
    longDescription: `Maison Valér is a luxury corporate gifting brand I created from concept to launch. The brand targets high-end B2B clients who want premium leather goods as corporate gifts.\n\nI developed the complete brand universe — name, logo, visual identity, editorial photography direction, packaging, and web experience. The aesthetic draws from French fashion houses with a Middle Eastern luxury sensibility.`,
    category:    ['Branding', 'UI/UX'],
    color:       '#100d04',
    year:        '2024',
    client:      'Maison Valér',
    role:        ['Brand Designer', 'Creative Director', 'Web Designer'],
    tags:        ['Luxury', 'Branding', 'Editorial', 'Web Design'],
  ...
  },
  {
    ...
    longDescription: `SIPPLE is a smart drinkware brand I designed from scratch. The product concept centres on MagSafe-compatible hydration tracking with a companion app.\n\nI created the full brand identity, product UI, app interface design, and marketing website. The challenge was making a tech product feel warm and lifestyle-oriented — not cold and clinical.`,
    category:    ['Branding', 'UI/UX'],
    color:       '#060d18',
    year:        '2024–2025',
    client:      'SIPPLE',
    role:        ['Brand Designer', 'UI/UX Designer', 'Creative Director'],
    tags:        ['Product Design', 'Branding', 'App UI', 'Tech'],
  ...
  },
  {
    ...
    longDescription: `A collection of AI-driven visual production work spanning product campaigns, lifestyle imagery, and editorial visuals. I use Midjourney, Sora, Higgsfield, and Nano Banana Pro as creative accelerators — not replacements for human direction.\n\nEvery image starts with a creative brief and ends with a polished, on-brand deliverable. The AI tools collapse the time between idea and execution.`,
    category:    ['AI Design', 'Art Direction'],
    color:       '#0a0618',
    year:        '2023–Present',
    client:      'Various',
    role:        ['AI Art Director', 'Creative Director'],
  ...
  },
  {
    ...
    color:       '#120808',
    year:        '2023–Present',
    client:      'Various B2B Clients',
    role:        ['Packaging Designer', 'Print Designer'],
  ...
  },
  {
    ...
    longDescription: `As a Graphic Design Faculty member at KELTRON Advanced Studies, I developed and delivered a comprehensive design curriculum covering UI/UX, branding, Adobe Creative Suite, and industry practice.\n\nI designed all teaching materials — slides, handouts, project briefs, and assessment criteria — to professional standards. 90% of my students secured design roles within 3 months of graduation.`,
    category:    ['Education', 'UI/UX'],
    color:       '#080a08',
    year:        '2019–2020',
    client:      'KELTRON Advanced Studies',
    role:        ['Design Faculty', 'Curriculum Designer'],
