...
import { SHOWREEL_ID } from '@/lib/videos'
...
export default function ShowreelSection() {
  ...
  const hasVideo = SHOWREEL_ID && !SHOWREEL_ID.startsWith('REPLACE')
    ...
    <section style={{
      ...
      {hasVideo ? (
        <div style={{ position:'absolute', inset:0, pointerEvents:'none' }}>
          <iframe
            ref={iframeRef}
            src={`https://www.youtube-nocookie.com/embed/${SHOWREEL_ID}?autoplay=1&mute=1&loop=1&playlist=${SHOWREEL_ID}&controls=0&modestbranding=1&rel=0&iv_load_policy=3&enablejsapi=1`}
      ...
      {/* Gradient overlays */}
      <div style={{ position:'absolute', inset:0, pointerEvents:'none',
        background:'linear-gradient(100deg,rgba(0,0,0,0.88) 0%,rgba(0,0,0,0.45) 55%,rgba(0,0,0,0.1) 100%)',
      }}/>
      <div style={{ position:'absolute', top:0, left:0, right:0, height:'25%', pointerEvents:'none',
      ...
      <div style={{
        ...
        <div style={{ maxWidth:'580px' }}>
          ...
          <div style={{
            ...
            fontFamily:'var(--font-mono)', fontSize:'10px', letterSpacing:'3px', color:'var(--orange)',
          }}>
            <span style={{
              width:'7px', height:'7px', background:'var(--orange)',
              borderRadius:'50%', animation:'blink 2s ease-in-out infinite', flexShrink:0,
            }}/>
            SHOWREEL 2026
          </div>
          ...
          <p style={{
            ...
            lineHeight:1.75, marginBottom:'32px', maxWidth:'380px',
          }}>
          ...
          <div style={{ display:'flex', gap:'12px', flexWrap:'wrap', alignItems:'center' }}>
            <Link href="/reel" style={{
              ...
              fontFamily:'Clash Display,Arial Black,sans-serif',
              fontWeight:600, fontSize:'11px', letterSpacing:'2px', textTransform:'uppercase',
            ...
            {hasVideo && (
              <button onClick={toggleMute} style={{
                ...
                padding:'13px 18px', borderRadius:'2px',
