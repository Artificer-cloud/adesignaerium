      ...
      <div className="credentials-page" style={{
        ...
        <div style={{ padding:'36px 44px 28px', borderBottom:'1px solid #1e1e1e', display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
          ...
          <div style={{ textAlign:'right' }}>
            ...
            <div style={{ fontFamily:'monospace', fontSize:'9px', letterSpacing:'1px', color:'#4a4a4a', marginBottom:'4px' }}>abhi@adesignaerium.com</div>
        ...
        <div style={{ padding:'22px 28px 28px', display:'flex', justifyContent:'space-between', alignItems:'flex-end' }}>
          <div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
              {['abhi@adesignaerium.com','+971 52 677 6884','adesignaerium.com','linkedin.com/in/abhijeethsubhash','behance.net/abhijeeth-subhash','@wonderartmedia'].map(c => (
