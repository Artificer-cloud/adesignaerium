...
export const metadata = { title: 'Shanghai Gifts — Case Study | Abhijeeth Subhash' }

export default function ShanghaiGiftsPage() {
  const project = projects.find(p => p.id === 'shanghai-gifts')!
  const others = projects.filter(p => p.id !== 'shanghai-gifts').slice(0, 3)
  return (
