...
export const metadata = { title: 'ECORA — Case Study | Abhijeeth Subhash' }

export default function EcoraPage() {
  const project = projects.find(p => p.id === 'ecora')!
  const others = projects.filter(p => p.id !== 'ecora').slice(0, 3)
  return (
