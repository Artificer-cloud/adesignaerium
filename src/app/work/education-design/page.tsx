...
export const metadata = { title: 'Education Design — Case Study | Abhijeeth Subhash' }

export default function EducationDesignPage() {
  const project = projects.find(p => p.id === 'education-design')!
  const others = projects.filter(p => p.id !== 'education-design').slice(0, 3)
  return (
