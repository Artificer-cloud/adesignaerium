...
export const metadata = { title: 'SIPPLE — Case Study | Abhijeeth Subhash' }

export default function SipplePage() {
  const project = projects.find(p => p.id === 'sipple')!
  const others = projects.filter(p => p.id !== 'sipple').slice(0, 3)
  return (
