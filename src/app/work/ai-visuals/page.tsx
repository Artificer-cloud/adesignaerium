...
export const metadata = { title: 'AI Visual Design — Case Study | Abhijeeth Subhash' }

export default function AiVisualsPage() {
  const project = projects.find(p => p.id === 'ai-visuals')!
  const others = projects.filter(p => p.id !== 'ai-visuals').slice(0, 3)
  return (
