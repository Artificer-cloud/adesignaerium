...
export const metadata = { title: 'Social & Motion — Case Study | Abhijeeth Subhash' }

export default function SocialMotionPage() {
  const project = projects.find(p => p.id === 'social-motion')!
  const others = projects.filter(p => p.id !== 'social-motion').slice(0, 3)
  return (
