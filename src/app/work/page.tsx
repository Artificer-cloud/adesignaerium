  ...
  return (
    <main style={{ paddingTop:'80px' }}>
      <section style={{ padding:'clamp(40px,6vh,80px) clamp(20px,6vw,80px) clamp(24px,4vh,40px)', maxWidth:'1400px', margin:'0 auto' }}>
        ...
        <h1 style={{ fontFamily:'Clash Display,Arial Black,sans-serif', fontWeight:700, fontSize:'clamp(44px,10vw,120px)', letterSpacing:'-4px', color:'var(--bone)', lineHeight:.88, marginBottom:'16px' }}>ALL WORK</h1>
            ...
            <Link key={project.id} href={`/work/${project.id}`} className="project-card"
              ...
              {project.coverImage && (
                <div style={{ position:'absolute', inset:0, zIndex:0 }}>
                  <Image src={project.coverImage} alt={project.title} fill style={{ objectFit:'cover', objectPosition:'center', opacity:0.35 }} onError={()=>{}}/>
