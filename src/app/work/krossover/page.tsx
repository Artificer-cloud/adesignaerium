...
export const metadata = { title: 'Krossover Gifts — Case Study | Abhijeeth Subhash' }

export default function KrossoverPage() {
  const project = projects.find(p => p.id === 'krossover')!
  const others = projects.filter(p => p.id !== 'krossover').slice(0, 3)
  return (
