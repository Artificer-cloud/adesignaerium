...
export const metadata = { title: 'Maison Valér — Case Study | Abhijeeth Subhash' }

export default function MaisonValerPage() {
  const project = projects.find(p => p.id === 'maison-valer')!
  const others = projects.filter(p => p.id !== 'maison-valer').slice(0, 3)
  return (
