    ...
    <main>
      ...
      <section ref={heroRef} onMouseMove={handleHeroMouse}
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr clamp(200px,30vw,420px)', gap:'clamp(24px,4vw,60px)', padding:'clamp(90px,12vh,130px) clamp(20px,6vw,80px) clamp(60px,8vh,100px)', maxWidth:'1400px', margin:'0 auto', width:'100%', alignItems:'center' }}>
          ...
          {/* RIGHT — Hero portrait, full bleed, no box */}
          <div style={{
            position:'relative',
            width:'100%',
            aspectRatio:'3/4',
            ...
            {/* Subtle doodle ring behind image */}
            ...
            {/* Full bleed image — no box, no border, no background */}
            <div style={{
              position:'relative',
              width:'100%',
              height:'100%',
            ...
            {/* Floating tag */}
            <div className="animate-float" style={{ position:'absolute', bottom:'14%', left:'-8%', zIndex:4, background:'rgba(255,77,0,0.12)', border:'1px solid rgba(255,77,0,0.3)', borderRadius:'100px', padding:'6px 16px', fontFamily:'var(--font-mono)', fontSize:'9px', letterSpacing:'2px', color:'var(--orange)' }}>
              CREATIVE DIRECTOR
            </div>
          </div>
        </div>
