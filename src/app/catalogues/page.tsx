      ...
      <section style={{ padding: 'clamp(40px,6vh,80px) clamp(20px,6vw,80px) clamp(24px,4vh,48px)', maxWidth: '1400px', margin: '0 auto', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: '24px' }}>
          <h1 style={{
            ...
            <span className="char-wrap" style={{lineHeight:'inherit',color:'inherit'}}><span className="char-inner" style={{animationDelay:'0.1s'}}>T</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'inherit'}}><span className="char-inner" style={{animationDelay:'0.17s'}}>H</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'inherit'}}><span className="char-inner" style={{animationDelay:'0.24s'}}>E</span></span><br />
            <span style={{ fontFamily: 'Cormorant Garamond,Georgia,serif', fontStyle: 'italic', fontWeight: 600 }}>
              <span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.4s'}}>C</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.47s'}}>a</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.54s'}}>t</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.61s'}}>a</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.68s'}}>l</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.75s'}}>o</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.82s'}}>g</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.89s'}}>u</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'0.96s'}}>e</span></span><span className="char-wrap" style={{lineHeight:'inherit',color:'var(--orange)'}}><span className="char-inner" style={{animationDelay:'1.03s'}}>.</span></span>
            </span>
          </h1>
